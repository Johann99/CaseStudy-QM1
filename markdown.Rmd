...
## das ganze mit numeric_fragebogen probieren
knn_fragebogen = kNN(fragebogen)

knn(fragebogen, variable = c(x,y))
...
## vektor der anzeigt wie viel Prozent NA pro Spalte vorhanden sind
...
numeric_fragebogen = fragebogen[-str_detect(names(fragebogen), 'txt')]

numeric_fragebogen = fragebogen[-robinsondf[,grep("txt",colnames(robinsondf))]]

numeric_fragebogen = fragebogen[-str_detect(names(fragebogen), 'val')]
