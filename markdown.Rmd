...
Durch die prozentuale Berechnung der NA's pro Spalte, verschaffen wir uns einen Überblick über die fehlenden NA's und haben direkt ein gutes Fundament, welches uns hilt zu entscheiden wie wir mit den fehlenden Werten umgehen können.
...
#mit ~ % NA's
plot(fragebogen$f4_8)
plot(knn_fragebogen$f4_8)
