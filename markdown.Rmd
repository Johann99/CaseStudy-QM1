...
#ggplot
#ggplot(knn_fragebogen, aes(f4_11)) + geom_bar(fill = "#0073C2FF") 
#ggplot(fragebogen, aes(f4_11)) + geom_bar(fill = "#0073C2FF") 

#ggplot
#ggplot(knn_fragebogen, aes(f4_5)) + geom_bar(fill = "#0073C2FF") 
#ggplot(fragebogen, aes(f4_5)) + geom_bar(fill = "#0073C2FF")

#ggplot 
#ggplot(knn_fragebogen, aes(f6_4)) + geom_bar(fill = "#0073C2FF") 
#ggplot(fragebogen, aes(f6_4)) + geom_bar(fill = "#0073C2FF")
...
barplot(l_bio_wichtigkeit_mean, main = "Wichtigkeit von Bio bei unterschiedlichen Lebensmittelarten", xlab=colnames(l_bio_wichtigkeit_mean), ylab = "Wichtigkeit", space = 0.2, cex.axis = 1, cex.names = 1, cex.lab = 1, cex.main = 1.5, col = "#69b3a2", las=2)
