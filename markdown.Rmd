...
#aufpassen da var erst im nächsten code chunk definiert wird
...
#Wie viele würden mehr bezahlen? --> 66%
price_sensitivity[price_sensitivity>0, .N]

#Wie viele würden mehr als 5 % bezahlen? --> 26% 
price_sensitivity[price_sensitivity>5, .N]

#Wie viele würden mehr als 10 % bezahlen? --> 7% 
price_sensitivity[price_sensitivity>10, .N]

#Wie viele würden mehr als 15 % bezahlen? --> 5% 
price_sensitivity[price_sensitivity>15, .N]

#Wie viele würden mehr als 20 % bezahlen? --> 2% 
price_sensitivity[price_sensitivity>20, .N]


plot(price_sensitivity,type="p")
